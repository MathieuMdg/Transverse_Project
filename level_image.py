...
class Level1(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(
            "assets/Level_background/background_salon.jpeg")  # attribue l'image des buttons
        self.image = pygame.transform.scale(self.image, (int(300 * pourcentage_x), int(200 * pourcentage_y)))  # redimensionne l'image sur l'écran
