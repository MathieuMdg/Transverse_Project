...
class Exit_Button(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = self.image.get_rect()  # Récupérer les coordonnées des légumes
        self.rect.x = 20  # attribue à la position du légume sa position initiale
        self.rect.y = height - 50 # place le légume en bas de l'écran
...
class Survie_Button(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.transform.scale(self.image, (300, 100))  # redimensionne l'image sur l'écran
        self.rect = self.image.get_rect()  # Récupérer les coordonnées des légumes
        self.rect.x = width - 300  # attribue à la position du légume sa position initiale
        self.rect.y = height - 50 # place le légume en bas de l'écran
